...
### Домашнее задание 12
1. [x] Добавить поле username и password
2. [x] Создать регистрации пользователя с отправкой и подтверждением через почту
3. [x] Создать страницу create с полем email с кнопкой submit
4. [x] Пользователь полем с is_active=False
5. [x] Отправляется почта с линком на перевод ис is_active=False на True
